...
/* # for 0.4.2.7 Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2020-03-13"

/* tor's build directory */
#define BUILDDIR "/tmp/tor-tor-0.4.2.7"

/* tor's configuration directory */
#define CONFDIR "/tmp/tor-tor-0.4.2.7/etc/tor"
...
#define PACKAGE_STRING "tor 0.4.2.7"
...
#define SRCDIR "/tmp/tor-tor-0.4.2.7"
